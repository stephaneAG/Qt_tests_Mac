...
void FortuneThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        FortuneThread *_t = static_cast<FortuneThread *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData FortuneThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FortuneThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_FortuneThread,
      qt_meta_data_FortuneThread, &staticMetaObjectExtraData }
};
